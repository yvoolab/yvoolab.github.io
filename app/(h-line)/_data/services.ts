...
export const services: HService[] = [
  {
    ...
    sellingPoints: [
      // 数据出处与四条红线见 ai-side-hustle/h-line/direct-clients/web-copy-2026-07-30.md
      // chaping 节（BrightLocal 2026）。国别对外模糊系 Del 2026-08-02 令；被问则如实答。
      "八成客人更愿光顾有评必回的店，四成不愿去从不回复的；套话回复一半人反感——所以我们一条一条写",
  ...
  },
  {
    ...
    path: "/shanghu/xunpan",
    title: "批发城里谁回得快，谁先拿单",
    // 2026-08-02：去「哈佛研究 2241 家企业」六字。数未换（遍搜无一手新研究可用），
    // 去的是可追溯到 2011 的钩，并对齐 chaping 页之改法。出处见 web-copy-2026-07-30.md
    subtitle: "一小时内回复，拿单机会高出近七倍。过了一夜，客人已经问了同行。",
    sellingPoints: [
...
export const oneTimeCards: MenuCard[] = [
  ...
  {
    title: "询盘秒回",
    body: "谁用得上：批发、外贸、装修队，凡靠邮件接单的生意。客户邮件 AI 打草稿、秒回您确认——客户不会因为等了一夜，跑去问您的同行（一小时内回复，拿单机会高出近七倍）。",
